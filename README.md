...
- **Rate Limiting**: Be aware of API rate limits for your chosen models
...
3. **Model Not Available**
   - Verify the model names in `config.py`
   - Check OpenRouter/Google AI service status
...
- Verify your API keys and model configurations
- Ensure all dependencies are properly installed

## 📝 License

This project is for educational and research purposes. Please ensure compliance with the terms of service for the AI models you're using.
...
- Review the configuration and API documentation
